...
* **Inactive:** Inactive Process Categories cannot have Processes assigned to them. Inactive Processes do not display as available options when [assigning a Process to a Category](../create-a-process.md#create-a-new-process). Furthermore, Processes assigned to an inactive Category no longer display to Requesters even though such Processes may be active.
