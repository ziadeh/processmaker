...
3. Edit the following Process configuration as necessary:
   ...
   * From the **Request Detail Screen** drop-down menu, select a [Display](../../design-forms/screens-builder/types-for-screens.md#display)-type ProcessMaker Screen to display the [summary for completed Requests](../../../using-processmaker/requests/request-details/summary-for-completed-requests.md#values-in-the-request) of that Process.
4. Click **Save**.
