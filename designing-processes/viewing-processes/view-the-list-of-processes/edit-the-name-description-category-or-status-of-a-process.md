...
3. Edit the following Process configuration as necessary:
   ...
   * From the **Cancel Screen** drop-down menu, select a [Display](../../design-forms/screens-builder/types-for-screens.md#display)-type [ProcessMaker Screen](../../design-forms/what-is-a-form.md) to display when a Request for this Process is canceled.
   ...
   * From the **Request Detail Screen** drop-down menu, select a Display-type ProcessMaker Screen to display the [summary for completed Requests](../../../using-processmaker/requests/request-details/summary-for-completed-requests.md#values-in-the-request) of that Process.
4. Click **Save**.
