...
3. Edit the following Process configuration as necessary:
   ...
   * From the **Request Detail Screen** drop-down menu, select a Display-type ProcessMaker Screen to display the [summary for completed Requests](../../../using-processmaker/requests/view-completed-requests.md#view-completed-requests-in-which-you-participated) of that Process.
4. Click **Save**.
