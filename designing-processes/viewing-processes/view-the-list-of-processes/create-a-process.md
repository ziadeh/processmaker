...
3. In the **Name** field, enter the name of the Process. Process names must be unique regardless of whether the Process is active or [archived](remove-a-process.md), and can only use alphanumeric characters and spaces. This is a required field.
