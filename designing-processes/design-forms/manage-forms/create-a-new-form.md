...
3. In the **Name** field, enter the name of the ProcessMaker Screen. ProcessMaker Screen names must be unique and can only use alphanumeric characters and spaces. This is a required field.
