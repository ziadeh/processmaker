...
7. In the **Email body** setting, enter the body text of the email. You may include mustache syntax within the **Email body** setting to reference Request data or Magic Variables.
