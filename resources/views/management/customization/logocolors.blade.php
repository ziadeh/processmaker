...
<div class="container page-content" id="logo-colors">
    ...
    <form>
        <label for="companyLogo">{{"companyLogo"}}</label>
        <!-- <input type="text" id="companyLogo" class="form-control inline-input" v-model="companyLogo"> -->
        <div class="form-group">
            <div class="d-flex">
                <input type="text" class="form-control inline-input">
                <button type="submit" class="btn inline-button text-light">Choose</button>
            </div>
            <small id="addCompanyLogo" class="form-text text-muted">Logo size must be 400x100. File format .jpg or .png</small>
        </div>
        <div class="form-group">
            <div class="d-flex">
                <input type="text" class="form-control inline-input">
